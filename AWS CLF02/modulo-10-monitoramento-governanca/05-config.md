# AWS Config — compliance e histórico de configurações
...
B) Monitora compliance e histórico de configurações (correta)
C) Cria backups
D) Gerencia usuários

Explicação:
- B) Correta: Config monitora compliance e histórico.
...
- Config = compliance de configuração | monitora e audita recursos | histórico de mudanças | automação de remediação | compliance facilitado