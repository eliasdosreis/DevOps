...
const COURSE = {
  title: "Kubernetes 01",
  shortTitle: "K8S-01 Lab",
  subtitle: "Fundamentos, Kind e manifestos essenciais",
  description:
  ...
  focus: [
    "Preparacao com Kind",
    "Pods, labels e namespaces",
    "Workloads, Services e Ingress",
    "Config, storage, HPA, probes, RBAC e projeto final",
  ],
};
...
const moduleImages = [
  ["00", "https://images.unsplash.com/photo-1667372393119-3d4c48d07fc9?auto=format&fit=crop&w=1200&q=80", "Prepare o ambiente local e entenda o papel do Kind antes dos manifestos."],
  ["01", "https://images.unsplash.com/photo-1515879218367-8466d910aaa4?auto=format&fit=crop&w=1200&q=80", "Fundamentos: namespaces, pods, labels e annotations para organizar o cluster."],
  ["02", "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=1200&q=80", "Workloads controlam replicas, atualizacoes, jobs e execucao programada."],
  ["03", "https://images.unsplash.com/photo-1520869562399-e772f042f422?auto=format&fit=crop&w=1200&q=80", "Rede no Kubernetes conecta pods, services, NodePort e Ingress."],
  ["04", "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1200&q=80", "ConfigMaps e Secrets separam configuracao e dados sensiveis da imagem."],
  ["05", "https://images.unsplash.com/photo-1544383835-bda2bc66a55d?auto=format&fit=crop&w=1200&q=80", "Storage exige entender classes, volumes, claims e o ciclo de vida do dado."],
  ["06", "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&w=1200&q=80", "Escalabilidade e probes ajudam o cluster a reagir com saude e previsibilidade."],
  ["07", "https://images.unsplash.com/photo-1563986768494-4dee2763ff3f?auto=format&fit=crop&w=1200&q=80", "RBAC define identidade, permissao e escopo para operar com seguranca."],
  ["08", "https://images.unsplash.com/photo-1497366811353-6870744d04b2?auto=format&fit=crop&w=1200&q=80", "Projeto final junta banco, backend, frontend e rede em uma entrega completa."],
];
