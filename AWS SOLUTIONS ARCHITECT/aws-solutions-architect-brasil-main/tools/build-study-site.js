...
const COURSE = {
  ...
  shortTitle: "SAA-C03 Lab",
  subtitle: "Estudo visual, quiz interativo e arquitetura senior",
  description:
    "Curso convertido para um site estatico com trilha por modulos, busca, progresso local, simulados interativos e revisao alinhada ao guia oficial AWS SAA-C03.",
  examSource:
    "Fonte oficial consultada em 2026-04-28: https://docs.aws.amazon.com/aws-certification/latest/solutions-architect-associate-03/solutions-architect-associate-03.html",
  domains: [
...
const moduleImages = [
  ["01", "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?auto=format&fit=crop&w=1200&q=80", "Estrategia de prova: leia o cenario, encontre os requisitos e elimine distratores."],
  ["02", "https://images.unsplash.com/photo-1563986768494-4dee2763ff3f?auto=format&fit=crop&w=1200&q=80", "Seguranca com identidade forte: quem pode fazer o que, em qual recurso e sob qual condicao."],
  ["03", "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&w=1200&q=80", "Labs de seguranca ajudam a transformar IAM de teoria em reflexo operacional."],
  ["04", "https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=1200&q=80", "Compute e escolha de motor: instancia, container, funcao ou servico gerenciado."],
  ["05", "https://images.unsplash.com/photo-1497366754035-f200968a6e72?auto=format&fit=crop&w=1200&q=80", "Alta disponibilidade nasce de redundancia, health checks e escala automatica."],
  ["06", "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=1200&q=80", "Armazenamento certo para cada dado: frequente, raro, arquivado, replicado ou versionado."],
  ["07", "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=1200&q=80", "S3 avancado pede atencao a lifecycle, replicacao, seguranca e custo."],
  ["08", "https://images.unsplash.com/photo-1520869562399-e772f042f422?auto=format&fit=crop&w=1200&q=80", "VPC e a planta da cidade: subnets, rotas, portas e caminhos privados."],
  ["09", "https://images.unsplash.com/photo-1520869562399-e772f042f422?auto=format&fit=crop&w=1200&q=80", "Labs de rede deixam claro onde o trafego passa e onde ele deve ser bloqueado."],
  ["10", "https://images.unsplash.com/photo-1544383835-bda2bc66a55d?auto=format&fit=crop&w=1200&q=80", "Dados pedem arquitetura: relacional, chave-valor, cache, analytics ou busca."],
  ["11", "https://images.unsplash.com/photo-1544383835-bda2bc66a55d?auto=format&fit=crop&w=1200&q=80", "Bancos relacionais na pratica: disponibilidade, backup, leitura e operacao gerenciada."],
  ["12", "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=1200&q=80", "DynamoDB recompensa bom desenho de chave, acesso previsivel e escala sob demanda."],
  ["13", "https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=1200&q=80", "DNS e CDN aproximam usuarios, reduzem latencia e protegem origens."],
  ["14", "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=1200&q=80", "Desacoplamento deixa produtores e consumidores respirarem em ritmos diferentes."],
  ["15", "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=1200&q=80", "Mensageria em lab mostra retry, DLQ, fanout e buffers contra picos."],
  ["16", "https://images.unsplash.com/photo-1667372393119-3d4c48d07fc9?auto=format&fit=crop&w=1200&q=80", "Containers organizam workloads portaveis com escolhas entre ECS, EKS e Fargate."],
  ["17", "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=1200&q=80", "Serverless troca servidor por eventos, integracao gerenciada e pagamento por uso."],
  ["18", "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1200&q=80", "Analytics e fluxo: coletar, transformar, consultar e entregar insight."],
  ["19", "https://images.unsplash.com/photo-1677442136019-21780ecad995?auto=format&fit=crop&w=1200&q=80", "IA no Associate costuma ser reconhecer o servico gerenciado certo para o caso."],
  ["20", "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1200&q=80", "Observabilidade e auditoria respondem: o que aconteceu, quando, por quem e com qual impacto."],
  ["21", "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&w=1200&q=80", "Migracao boa equilibra janela, volume, risco, custo e mudanca na aplicacao."],
  ["22", "https://images.unsplash.com/photo-1497366811353-6870744d04b2?auto=format&fit=crop&w=1200&q=80", "DR e continuidade comecam por RTO/RPO antes de escolher multi-AZ ou multi-region."],
  ["23", "https://images.unsplash.com/photo-1554224155-6726b3ff858f?auto=format&fit=crop&w=1200&q=80", "Governanca multi-conta combina limites, visibilidade, padroes e FinOps."],
  ["24", "https://images.unsplash.com/photo-1516321497487-e288fb19713f?auto=format&fit=crop&w=1200&q=80", "Conectividade hibrida conecta data center, VPCs e servicos com isolamento e escala."],
  ["25", "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=1200&q=80", "Criptografia separa dado, chave, segredo, permissao e rotacao."],
  ["26", "https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=1200&q=80", "Well-Architected organiza decisoes por pilares para melhorar sistemas reais."],
  ["27", "https://images.unsplash.com/photo-1556761175-b413da4baf72?auto=format&fit=crop&w=1200&q=80", "Casos reais treinam trade-offs: seguro, resiliente, rapido, barato e operavel."],
  ["28", "https://images.unsplash.com/photo-1515879218367-8466d910aaa4?auto=format&fit=crop&w=1200&q=80", "Labs end-to-end geram evidencia para portifolio, entrevista e troubleshooting."],
  ["29", "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?auto=format&fit=crop&w=1200&q=80", "Simulado e treino de decisao sob tempo: leia, elimine, escolha e revise."],
  ["30", "https://images.unsplash.com/photo-1456324504439-367cee3b3c32?auto=format&fit=crop&w=1200&q=80", "Glossario e mapa mental reduzem confusoes entre servicos parecidos."],
  ["31", "https://images.unsplash.com/photo-1488998427799-e3362cec87c3?auto=format&fit=crop&w=1200&q=80", "Links oficiais mantem o estudo conectado ao comportamento atual dos servicos AWS."],
];
...
function fixMojibake(text) {
  if (!/[ÃÂâ€ðŸ]/.test(text)) return text;
  try {
    ...
    const oldScore = (text.match(/[ÃÂâ€ðŸ]/g) || []).length;
    const newScore = (repaired.match(/[ÃÂâ€ðŸ�]/g) || []).length;
...
function moduleInfo(relative) {
  ...
  if (match) {
    const label = `Modulo ${match[1]} - ${fixMojibake(match[2]).replace(/-/g, " ")}`;
    return { id: slugify(first), label, raw: first, number: match[1] };
  }
...
function codeToHtml(relative, content) {
  ...
  return `<div class="code-study">
    ...
    <p><strong>Caminho original:</strong> <code>${escapeHtml(relative)}</code></p>
    <p>Leia este arquivo como evidencia pratica do laboratorio. Primeiro entenda o objetivo, depois revise variaveis, custos possiveis, permissoes e pontos de rollback.</p>
...
function officialNoticeForOutdatedExamWeights(content) {
  ...
  const hasOutdatedWeights =
    /Design Resilient Architectures[^.\n]{0,80}30%/i.test(text) ||
    /High-Performing[^.\n]{0,80}28%/i.test(text) ||
    /Secure Applications[^.\n]{0,80}24%/i.test(text) ||
    /Cost-Optimized Architectures[^.\n]{0,80}18%/i.test(text);
  if (!hasOutdatedWeights) return "";
  return `<aside class="official-note">
    <strong>Atualização oficial SAA-C03 conferida em 2026-04-28</strong>
    <p>Este arquivo fonte menciona pesos antigos em algum trecho. Para estudo de prova, use o guia oficial atual: Secure Architectures 30%, Resilient Architectures 26%, High-Performing Architectures 24% e Cost-Optimized Architectures 20%.</p>
    <p><a href="https://docs.aws.amazon.com/aws-certification/latest/solutions-architect-associate-03/solutions-architect-associate-03.html">Guia oficial AWS Certified Solutions Architect - Associate (SAA-C03)</a></p>
  </aside>`;
}
...
function renderStandaloneLesson(lesson, prev, next, modules) {
  ...
  <article class="lesson-card full" style="border-top:6px solid ${mod?.accent || "#ff9900"}">
    <div class="lesson-toolbar">
      <div class="lesson-kicker">${escapeHtml(lesson.moduleLabel)} - ${lesson.readingTime} min - ${escapeHtml(lesson.relative)}</div>
    </div>
...
function buildData(lessons) {
  ...
  const modules = Array.from(moduleMap.values())
    ...
    .map((mod, index) => ({
      ...
      icon: mod.number === "00" ? "AWS" : mod.number,
  ...
  <div class="app-shell">
    <aside class="sidebar" aria-label="Navegacao dos modulos">
      <a class="brand" href="#inicio">
        ...
        <span>
          ...
          <small>Arquitetura, prova e labs</small>
        </span>
      </a>
    ...
    <main class="main-area">
      <section class="hero-section" id="inicio">
        <div class="hero-copy">
          <span class="eyebrow">AWS Certified Solutions Architect - Associate</span>
          <h1>Estude SAA-C03 como arquiteto: trade-offs antes de decoreba.</h1>
        ...
        <div class="architecture-visual" aria-label="Diagrama visual de arquitetura AWS">
          <div class="cloud-node core">SAA</div>
          <div class="cloud-node node-a">IAM</div>
          <div class="cloud-node node-b">VPC</div>
          <div class="cloud-node node-c">EC2</div>
          <div class="cloud-node node-d">S3</div>
          <div class="cloud-node node-e">RDS</div>
      ...
      <section class="toolbar" aria-label="Ferramentas de estudo">
        <label class="search-box">
          <span>Buscar</span>
          <input id="searchInput" type="search" placeholder="Ex: Multi-AZ, IAM, VPC endpoint, custo">
        </label>
...
function appJs() {
  ...
  const storageKey = "saaSolutionsArchitectCompleted";
  const state = {
    query: "",
    module: "all",
    hideCompleted: false,
  ...
  function renderLesson() {
    ...
    els.lessonView.innerHTML = '<div class="lesson-toolbar"><div><div class="lesson-kicker">' + lesson.moduleLabel + ' - ' + lesson.kind + ' - ' + lesson.readingTime + ' min - ' + lesson.relative + '</div></div>' +
...
/* Extensoes pequenas do curso SAA-C03 sobre o tema oficial AWS CLF02. */
...
function readme(lessonCount, moduleCount) {
  return `# Site de estudo - AWS Solutions Architect Associate
...
\`\`\`bash
node "AWS SOLUTIONS ARCHITECT/aws-solutions-architect-brasil-main/tools/build-study-site.js"
\`\`\`
...
## Fonte oficial usada para certificacao

${COURSE.examSource}

Dominios oficiais atuais do SAA-C03:
